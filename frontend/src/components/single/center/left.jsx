    ...
    <div className="flex column gap-1">
      ...
      >
        <div className="flex item-center w-100 justify-space">
          <h3 className="flex-1 fs-20 text-dark text-extra-bold">
        ...
        <span className="fs-14 flex gap-1 item-center text-dark text-light">
      ...
      <div className=" listing_prop item-center bottom w-100">
        ...
        >
          ...
          <h4 className="text-dark text-bold fs-14  ">
            Bedroom
            <span className="block fs-12 text-grey text-light">1 king bed</span>
          </h4>
        </div>{" "}
        <div
          className="flex cardItem item-center gap-1"
      ...
      <ul className="flex bottom column gap-1">
        ...
        <li className="flex fs-14 text-dark item-start gap-1">
          <Date />
      ...
      <div className="flex column w-100 gap-1">
        <h3 className="fs-20 text-bold">
          ...
          <span
            ...
            className="block text-grey text-light fs-14"
          >
